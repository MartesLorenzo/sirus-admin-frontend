...
export default function ClientTracking() {
  ...
  return <>
    ...
    <div className="two-column"><Panel title="Acesso do cliente">
      ...
      <label>Descrição<textarea required rows="4" value={message} onChange={(event) => setMessage(event.target.value)} /></label>
